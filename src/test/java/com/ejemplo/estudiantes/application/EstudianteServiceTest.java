...
public class EstudianteServiceTest {
    ...
    @InjectMocks
    private CreacionEstudianteService estudianteServiceCrear;

    @InjectMocks
    private EliminacionEstudianteService estudianteServiceEliminar;
    @InjectMocks
    ...
    void testEliminarEstudiante(){
        ...
        estudianteServiceEliminar.eliminarEstudiante(id);
